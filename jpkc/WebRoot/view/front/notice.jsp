...
<script type="text/javascript" src="<%=basePath %>/js/front/notice.js"></script>
<script type="text/javascript" src="<%=basePath %>/js/front/front.js"></script>
</head>

<body onload="loadData(1,10,'<%=basePath %>/frontNotice/noticeList');">
...
<div class="row-fluid" style="min-height: 500px;">
	...
	<div id="content" class="col-xs-10" style="width: 85%;">  
		<div class="row-fluid">
			<h3 style="text-align: center;">通知公告</h3>  
			
			<div class="col-xs-12"><div class="info survey">
				<div class="details" id="notice_content"></div>
