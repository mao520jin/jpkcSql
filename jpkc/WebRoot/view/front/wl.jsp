...
<html>
	...
	<body>
		...
		<article class="main">
			...
			<section class="wlmain wlmain_item1" style="display:block">1</section>
			<section class="wlmain wlmain_item2">2</section>
			<section class="wlmain wlmain_item3">3</section>
			<section class="wlmain wlmain_item4">4</section>
			<section class="wlmain wlmain_item5">5</section>
			<section class="wlmain wlmain_item6">6</section>
			<section class="wlmain wlmain_item7">7</section>
			<section class="wlmain wlmain_item8">8</section>
			<section class="wlmain wlmain_item9">9</section>
		</article>
		<footer>
