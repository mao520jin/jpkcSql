	...
	<body>
		...
		<article class="main">
			...
			<jsp:include page="/view/front/include/left.jsp" flush="true">
				<jsp:param name="menuActive" value="zlxz" />
			</jsp:include>
		
			<section class="wlmain wlmain_item1">
				<c:forEach items="${pager.content}" var="o">
					<p>
						<a href="${basePath }/front/resource/download/${o.id }">${o.title }</a>
				...
				<jsp:include page="/view/front/include/pager.jsp" flush="true">
					<jsp:param name="pagePath" value="/front/resource/list?type=zlxz" />
				</jsp:include>
			</section>
