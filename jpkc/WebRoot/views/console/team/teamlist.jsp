...
<title>团队成员列表 - ${APP_CONSOLE_NAME_CN} - ${APP_NAME_CN}</title>
...
<div id="col3" role="main">
	<div id="col3_content" class="clearfix">
		<form method="post" action="${basePath}/team/list" class="yform columnar" role="application">
			<fieldset>
				<div class="subcolumns">
					<div class="c25l">
						<div class="subcl type-text">
							<label for="memberName" >成员名称：
							</label><input type="text" name="memberName" id="memberName" size="15" value="${memberName }"/>
						</div>
					</div>
					<div class="c25r">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="full">
			...
			<tbody>
				<tr><th scope="col">序号</th><th scope="col">成员名称</th><th scope="col">邮箱</th><th scope="col">电话</th><th scope="col">类型</th><th scope="col">创建时间</th><th scope="col">操作</th></tr>
