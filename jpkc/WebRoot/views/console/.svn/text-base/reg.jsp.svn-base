...
<title>注册 - ${APP_CONSOLE_NAME_CN} - ${APP_NAME_CN}</title>
...
<jsp:include page="/views/console/include/nav.jsp"><jsp:param name="hListActive" value="reg" /></jsp:include>
		...
		<form method="post" action="" class="yform" role="application">
			<fieldset>
				...
				<div class="type-text">
					...
					<input type="text" name="vcode" id="vcode" size="20" />
				</div>
			</fieldset>
			<div class="type-button">
				<input type="submit" value="登录" class="submit" id="loginBtn" name="loginBtn" />
			</div>
		</form>
	</div>
